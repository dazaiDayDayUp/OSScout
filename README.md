...
- **Phase 4 — RAG 深度优化**：知识库扩充（CHAOSS/OpenSSF/治理文档）、行业基准数据、语义分块、混合检索（向量+BM25）、交叉编码器重排序、Self-RAG、引用追踪
- **Phase 5 — 真正的 Agent 架构**：LLM Function Calling、MCP 工具注册表、Plan-and-Execute 自主规划、ReAct 自主循环、动态分析流程、Reflection 反思
...
| **Phase 4** | **RAG 深度优化（知识扩充/分块/混合检索/Rerank/Self-RAG）** | **当前重点** |
